    ...
    <div className="space-y-4 pb-20">
      ...
      <div className="bg-[#EDE5D6] border border-[#D8D0C2] rounded-2xl p-5 shadow-xs flex items-center gap-4">
        ...
        <div>
          ...
          <div className="text-xs text-[#5D5B53] font-mono">
        ...
        <div className="bg-[#EDE5D6] border border-[#D8D0C2] rounded-xl p-4 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-serif font-bold text-[#292925] flex items-center gap-1.5">
              ...
              Assigned Hardware Wristband
            </span>
            <span className="subtle-badge badge-normal">{band?.status || 'ACTIVE'}</span>
          </div>

          <div className="grid grid-cols-2 gap-2 text-xs pt-1">
            <div className="bg-[#F6F1E7] p-2.5 rounded-lg border border-[#D8D0C2]">
              <span className="text-[10px] text-[#878377] block">Band Identifier</span>
              <span className="font-mono font-bold text-[#292925]">{worker.assignedBandId}</span>
            </div>
            <div className="bg-[#F6F1E7] p-2.5 rounded-lg border border-[#D8D0C2]">
              <span className="text-[10px] text-[#878377] block">Shelf Age</span>
              <span className="font-mono font-bold text-[#292925]">{band?.shelfAgeDays || 24} days</span>
            </div>
          </div>
      ...
      <div className="bg-[#EDE5D6] border border-[#D8D0C2] rounded-xl p-4 space-y-3">
        <div className="flex items-center justify-between">
          <span className="text-xs font-serif font-bold text-[#292925]">
            Switch Active Role (Demo Access)
          </span>
          <span className="text-[10px] font-mono bg-[#71806B]/20 text-[#4F5D4B] px-1.5 py-0.5 rounded">
            SIH 2026
          </span>
        </div>
      ...
      <div className="pt-3">
        <button
          onClick={logout}
          className="w-full py-3 bg-[#F6F1E7] border border-[#9A6258]/60 text-[#7A342B] rounded-xl font-medium text-xs flex items-center justify-center gap-2 active:bg-[#F6E2DF] transition-all"
        >
