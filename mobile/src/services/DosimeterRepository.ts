...
export const DEMO_SAMPLES: DemoSampleBadge[] = [
  {
    id: 'sample-1',
    label: 'Stage 1: Fresh Baseline (0.125 ppm·h)',
    bandId: 'SARVAS-0001',
    workerId: 'WRK-1042',
  ...
  {
    id: 'sample-2',
    label: 'Stage 2: Trace Low Exposure (1.00 ppm·h)',
    bandId: 'SARVAS-0010',
    workerId: 'WRK-2048',
  ...
  {
    id: 'sample-3',
    label: 'Stage 3: Action Level / Monitor (5.00 ppm·h)',
    bandId: 'SARVAS-0066',
    workerId: 'WRK-2048',
    workerName: 'Rahul Shetty',
    workLocation: 'Hydrocracker Unit 2 - Reactor Top Deck',
  ...
  {
    id: 'sample-4',
    label: 'Stage 4: Critical PEL Exceeded (20.00 ppm·h)',
    bandId: 'SARVAS-0082',
    workerId: 'WRK-3012',
  ...
  {
    id: 'sample-5',
    label: 'Stage 5: Seal Breached / Ingress (10.00 ppm·h)',
    bandId: 'SARVAS-0205',
    workerId: 'WRK-3012',
    workerName: 'Sanjay Rao',
    workLocation: 'Desulfurization Unit - Pre-Heater Flange',
    estimatedDose: 10.00,
    status: 'REVIEW',
    confidence: 88,
    temperature: 25,
