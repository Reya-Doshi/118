      ...
      <div className="bg-[#B08A55]/15 border border-[#B08A55]/35 rounded-xl p-4 flex items-start gap-3 text-xs text-[#292925]">
        ...
        <div className="space-y-1">
          ...
          <p className="leading-relaxed text-[#292925]/85">
            <strong>Permanent Stain Mandate:</strong> Reversible organic chelate complexes fade over days due to atmospheric oxygen oxidation. Our system employs <strong>Dual-Zone Insoluble Metal-Sulfide Precipitation</strong>: Silver Nitrate (AgNO₃) forms <strong>Ag₂S</strong> (<em>K<sub>sp</sub> ≈ 6 × 10⁻⁵¹</em>, permanent black stain for 0.125–10 ppm·h) and Copper Sulfate (CuSO₄) forms <strong>CuS</strong> (<em>K<sub>sp</sub> ≈ 6.3 × 10⁻³⁶</em>, permanent olive-brown stain for 10–160 ppm·h). Anhydrous CuSO₄ provides a visible <strong>seal-breach expiry indicator</strong> (turns blue on moisture ingress). To eliminate UV photo-reduction of Ag⁺, a top optical UV-blocking ePTFE membrane (&lt;390 nm cutoff) protects the sensor while permitting H₂S gas diffusion, while a stagnant-diffusion air gap (Fick's 1st Law) renders mass uptake independent of refinery wind speed (&gt;0.1 m/s).
          </p>
        </div>
      </div>
