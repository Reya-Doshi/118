...
export const DEMO_SAMPLES: DemoSample[] = [
  {
    id: 'sample-a',
    name: 'Stage 1 — Off-White / Cream (Fresh Baseline)',
    badgeId: 'DS-1042',
    workerName: 'Arjun Kumar',
    dosePpmH: 0.14,
    status: 'NORMAL',
    confidenceScore: 96,
    description: 'Pristine unreacted AgNO₃ / CuSO₄ dual-zone paper strip. Zone A baseline cream (#EDECE5), Zone B turquoise (#AED3E8). Safe shift level.',
    stripColorHex: '#EDECE5',
    stripColorBg: 'bg-[#EDECE5]',
    tempC: 25,
    humidityPercent: 50,
  ...
  {
    id: 'sample-b',
    name: 'Stage 2 — Warm Light Gray (Low Exposure)',
    badgeId: 'DS-1088',
    workerName: 'Rahul Shetty',
    dosePpmH: 0.24,
    status: 'NORMAL',
    confidenceScore: 94,
    description: 'Trace silver sulfide (Ag₂S) warm-gray reaction on Zone A (#D8D4CD). Well within safe 8-hour shift limits.',
    stripColorHex: '#D8D4CD',
    stripColorBg: 'bg-[#D8D4CD]',
    tempC: 27,
    humidityPercent: 55,
  ...
  {
    id: 'sample-c',
    name: 'Stage 3 — Slate Gray (Action Level / Monitor)',
    badgeId: 'DS-1088',
    workerName: 'Rahul Shetty',
    dosePpmH: 0.72,
    status: 'MONITOR',
    confidenceScore: 92,
    description: 'Action level reached (ACGIH TLV). Zone A slate-gray Ag₂S darkening (#928D88); worker rotation mandated.',
    stripColorHex: '#928D88',
    stripColorBg: 'bg-[#928D88]',
    tempC: 29,
    humidityPercent: 67,
  ...
  {
    id: 'sample-d',
    name: 'Stage 4 — Dark Charcoal (Elevated Review)',
    badgeId: 'DS-1091',
    workerName: 'Sanjay Rao',
    dosePpmH: 1.24,
    status: 'REVIEW',
    confidenceScore: 89,
    description: 'Significant Ag₂S and CuS precipitation (#68615C). Exceeds 1.00 ppm·h shift action threshold. Review alert triggered.',
    stripColorHex: '#68615C',
    stripColorBg: 'bg-[#68615C]',
    tempC: 31,
    humidityPercent: 71,
  ...
  {
    id: 'sample-e',
    name: 'Stage 5 — Dense Black / Critical (PEL Exceeded)',
    badgeId: 'DS-1091',
    workerName: 'Sanjay Rao',
    dosePpmH: 1.99,
    status: 'REVIEW',
    confidenceScore: 91,
    description: 'OSHA PEL exceeded. Zone A dense black Ag₂S (#504A44), Zone B olive-slate CuS (#97ACB7). Immediate evacuation.',
    stripColorHex: '#504A44',
    stripColorBg: 'bg-[#504A44]',
    tempC: 34,
    humidityPercent: 75,
